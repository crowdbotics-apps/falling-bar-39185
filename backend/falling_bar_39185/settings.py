"""
Django settings for falling_bar_39185 project.
...
ROOT_URLCONF = 'falling_bar_39185.urls'
...
WSGI_APPLICATION = 'falling_bar_39185.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "falling_bar_39185 API",
    "DESCRIPTION": "API documentation for falling_bar_39185 App",
    "VERSION": "v1",
}
